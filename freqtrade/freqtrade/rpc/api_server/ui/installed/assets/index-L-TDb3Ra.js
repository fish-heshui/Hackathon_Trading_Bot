...
`,Xe={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},et=ie.extend({name:"chip",style:Ze,classes:Xe}),tt={name:"BaseChip",extends:me,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:et,provide:function(){return{$pcChip:this,$parentInstance:this}}},le={name:"Chip",extends:tt,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(t){(t.key==="Enter"||t.key==="Backspace")&&this.close(t)},close:function(t){this.visible=!1,this.$emit("remove",t)}},computed:{dataP:function(){return $({removable:this.removable})}},components:{TimesCircleIcon:fe}},it=["aria-label","data-p"],nt=["src"];function lt(e,t,i,l,o,n){return o.visible?(a(),d("div",s({key:0,class:e.cx("root"),"aria-label":e.label},e.ptmi("root"),{"data-p":n.dataP}),[p(e.$slots,"default",{},function(){return[e.image?(a(),d("img",s({key:0,src:e.image},e.ptm("image"),{class:e.cx("image")}),null,16,nt)):e.$slots.icon?(a(),v(C(e.$slots.icon),s({key:1,class:e.cx("icon")},e.ptm("icon")),null,16,["class"])):e.icon?(a(),d("span",s({key:2,class:[e.cx("icon"),e.icon]},e.ptm("icon")),null,16)):h("",!0),e.label!==null?(a(),d("div",s({key:3,class:e.cx("label")},e.ptm("label")),I(e.label),17)):h("",!0)]}),e.removable?p(e.$slots,"removeicon",{key:0,removeCallback:n.close,keydownCallback:n.onKeydown},function(){return[(a(),v(C(e.removeIcon?"span":"TimesCircleIcon"),s({class:[e.cx("removeIcon"),e.removeIcon],onClick:n.close,onKeydown:n.onKeydown},e.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):h("",!0)],16,it)):h("",!0)}le.render=lt;var ot=`
    .p-multiselect {
        display: inline-flex;
        cursor: pointer;
        position: relative;

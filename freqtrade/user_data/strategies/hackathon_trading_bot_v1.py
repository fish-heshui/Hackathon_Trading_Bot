...
class Hackathon_Trading_Bot_V1(IStrategy):
    ...
    # Entry parameters
    ema_candles_entry = 12

    # Exit parameters
    ema_candles_exit = 22
    exit_threshold_1 = 1.008
    exit_threshold_2 = 1.01
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe["price_change_pct"] = 100 * dataframe["close"]/ dataframe["open"] *  - 100

        dataframe["ema_entry"] = ta.EMA(dataframe, timeperiod=12)
        dataframe["ema_exit"] = ta.EMA(dataframe, timeperiod=22)

...
class KamaFama(IStrategy):
    max_open_trades = 2
    if IS_LIVE_TRADING:
        api_client = RoostooAPIClient(max_trade=max_open_trades)  # roostoo
    ...
    plot_config = {
        "main_plot": {"ma_buy": {"color": "#27d81b"}, "ma_sell": {"color": "#d0da3e"}, "hma_50": {"color": "#3edad8"}},
        "subplots": {
            "FKMAMA": {"mama": {"color": "#d0da3e"}, "fama": {"color": "#da3eb8"}, "kama": {"color": "#3edad8"}},
    ...
    def populate_entry_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[buy, "enter_long"] = 1
    ...
    def confirm_trade_entry(
        ...
        **kwargs,
        ...
        # roostoo
        if IS_LIVE_TRADING:
            self.api_client.wrapped_buy(pair.replace("/USDT", "/USD"))
